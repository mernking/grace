...
export const metadata = {
  title: "Boundless Bolt service | Professional Web Development & Automation Services",
  description:
...
const serviceData = [
  ...
  {
    image: "/images/service/tech-seo.svg",
    title: "Technical SEO",
  ...
  {
    image: "/images/service/web-design.svg",
    title: "Web Design",
...
export default function ServicesPage() {
  return (
    <div className="w-full flex flex-col gap-3 p-2 justify-center items-center">
      ...
      <div className="w-full md:max-w-[1200px] gap-5 grid grid-cols-1 md:grid-cols-3">
